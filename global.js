...
const initialize = async () => {
  ...
  document.getElementById("menu-burger").addEventListener("click", () => {
    ...
    let smallMenu = `
      <div class="w-screen h-screen bg-gray-100 fixed top-0 left-0 flex flex-col justify-center items-center">
        <!-- Pages -->
        <div>
          <a
            href="/"
            class="group text-lg font-medium text-gray-700 transition duration-300"
            >Home
            <span
              class="block max-w-0 group-hover:max-w-full transition-all duration-300 h-0.5 bg-gray-600"
            ></span>
        ...
        <!-- Close Button -->
        <div class="fixed top-10 right-10 text-3xl">
